 ...
 * @filesource admin/views/calendar/view.html.php
...
class XbjournalsViewCalendar extends JViewLegacy {
...
//        ToolbarHelper::save2copy('server.save2copy');
    ...
    protected function setDocument()
    {
        ...
        $document->setTitle(strip_tags(($this->item->id == 0) ? Text::_('XBJOURNALS_ADMIN_NEWCALENDAR_TITLE') : Text::_('XBJOURNALS_ADMIN_EDITCALENDAR_TITLE')));
    }
