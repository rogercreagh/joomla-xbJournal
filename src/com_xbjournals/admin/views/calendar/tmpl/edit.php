...
<form action="<?php echo JRoute::_('index.php?option=com_xbjournals&view=calendar&layout=edit&id=' . (int) $this->item->id); ?>"
    ...
    <div class="row-fluid form-horizontal">
		<div class="span12">
			...
			<?php echo HTMLHelper::_('bootstrap.addTab', 'myTab', 'server', JText::_('XBJOURNALS_SERVER')); ?>
	          	<h4><?php echo Text::_('XBJOURNALS_CALENDAR_SERVER_INFO'); ?></h4>
	          	<p class="xbit">These fields are all set on the CalDAV Server and are readonly here</p>
    			<div class="row-fluid">
    				<div class="span6">
