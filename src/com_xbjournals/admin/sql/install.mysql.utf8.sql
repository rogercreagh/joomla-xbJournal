...
CREATE TABLE IF NOT EXISTS `#__xbjournals_calendars` (
  ...
  `cal_url` varchar(190) NOT NULL DEFAULT '' COMMENT 'blank for local store',
...
CREATE TABLE IF NOT EXISTS `#__xbjournals_vjournal_entries` (
  ...
  `html_desc` text DEFAULT '',
  `description` text DEFAULT '',
  `class` text COMMENT '->access', 
  `status` text COMMENT '->catid', 
  `x-status` text COMMENT '->catid', 
  `categories` text COMMENT '->tags', 
