...
/*******
 * @package xbJournals
 * @filesource admin/models/fields/notebooks.php
...
class JFormFieldNotebooks extends JFormFieldList {
    
    protected $type = 'Notebooks';
