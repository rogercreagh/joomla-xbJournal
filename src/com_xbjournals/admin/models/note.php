 ...
 * @filesource admin/models/note.php
...
class XbjournalsModelNote extends AdminModel {
    
    public $typeAlias = 'com_xbjournals.note';
...
//             $item->tags = $tagsHelper->getTagIds($item->id, 'com_xbmaps.map');
    ...
    public function getTable($type = 'note', $prefix = 'XbjournalsTable', $config = array()) {
    ...
    public function getForm($data = array(), $loadData = true) {
        ...
        $form = $this->loadForm( 'com_xbjournals.note', 'note',
    ...
    protected function loadFormData() {
        $data = Factory::getApplication()->getUserState('com_xbjournals.edit.note.data', array() );
    ...
    protected function prepareTable($table) {
        ...
        if (empty($table->id)) {
            ...
            if (empty($table->ordering)) {
                ...
                ->select('MAX(ordering)')
                ->from($db->quoteName('#__xbjournals_notes'));
