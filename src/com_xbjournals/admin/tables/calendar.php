 ...
 * @filesource admin/tables/calendar.php
...
class XbjournalsTableCalendar extends Table
{
    public function __construct(&$db) {
        $this->setColumnAlias('published', 'state');
        parent::__construct('#__xbjournals_calendars', 'id', $db);
        Tags::createObserver($this, array('typeAlias' => 'com_xbjournals.calendar'));
    }
...
//         }
        ...
        if (($this->id == 0) && (XbjournalsHelper::checkDBvalueExists($title,'#__xbjournals_calendars'))) {
        ...
        if (($this->id == 0) && (XbjournalsHelper::checkDBvalueExists($this->alias,'#__xbjournals_calendars','alias'))) {
            $num=1;
            $test = $this->alias.'-'.$num;
